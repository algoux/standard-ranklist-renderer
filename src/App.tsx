...
class App extends React.Component<any, State> {
  ...
  render() {
    ...
    if (this.state.error) {
      ...
      return <div className={classnames({ 'plugin_root_scroll-solution': enableScrollSolution })}>
        <Ranklist data={data} />
        ...
        <ScrollSolution enabled={enableScrollSolution} dataUrl={scrollSolutionPath} interval={2000} />
      </div>;
